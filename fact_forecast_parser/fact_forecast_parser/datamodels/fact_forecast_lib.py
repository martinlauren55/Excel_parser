...
class Company(FactForecastBase):
...
class FactForecast(FactForecastBase):
    def __init__(self, input_data: str, output_data: str,
        ...
        self._company = Company(input_data=input_data, output_data=output_data)
